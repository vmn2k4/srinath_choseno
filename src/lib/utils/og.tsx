...
//
// Shared by the live fallback route (src/app/news/[slug]/opengraph-image.tsx)
// and the one-time generator (generateNewsArticleOgImage in
// src/lib/services/news.ts) so both ever produce pixel-identical output.
// Takes plain fields rather than a Supabase row shape so neither caller has
// to agree on a query shape with this file.
