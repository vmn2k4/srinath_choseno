...
<body>
    <div class="container">
        ...
        <div class="section" style="margin: 28px 0;">
            ...
            <div style="background: #0f172a; border-radius: 12px; padding: 14px; text-align: center; border: 1px solid #334155; box-shadow: 0 4px 14px rgba(0,0,0,0.12);">
                <a href="https://www.youtube.com/watch?v=WJIpU9Cyoho" target="_blank" rel="noopener noreferrer" style="display: block; text-decoration: none; position: relative;" title="Click to watch Choseno complete product demo">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse; max-width: 540px; margin: 0 auto;">
                        <tr>
                            <td align="center" style="position: relative; border-radius: 8px; overflow: hidden; padding: 0; margin: 0;">
                                <div style="position: relative; display: block; width: 100%; max-width: 540px;">
                                    <img src="https://img.youtube.com/vi/WJIpU9Cyoho/maxresdefault.jpg" alt="Choseno Product Demo Video" width="540" style="width: 100%; max-width: 540px; height: auto; display: block; border-radius: 8px; margin: 0 auto; border: 0;" />
