/**
 * OpenGraph Image Generation Constants & Utilities
 * Used by all opengraph-image.tsx files across the app
 */
...
/**
 * Renders a consistent OpenGraph card for elections, candidates, wall posts, etc.
 * Features: Choseno branding, eyebrow label, bold title, optional avatar/photo,
 * subtle gradient background with decorative glow blobs.
 */
export function renderOgCard({
  ...
  subtitle,
  photoUrl,
}: RenderOgCardProps): ImageResponse {
