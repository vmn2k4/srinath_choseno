...
### Required JSON Structure:
{
  ...
  "tweetarticle": "OPTIONAL but recommended. A long-form, structured, strictly neutral post for X (Twitter) Premium / X Articles (~800-1,500 characters) — this is the deep-dive version, distinct from the short 'tweet' hook and the review-first 'tweetmedium'. Structure: a short bolded headline-style opening line, then 3-5 concise bullet points pulling the concrete facts/numbers/mechanics straight from 'body' (never inventing new ones), then one line acknowledging both sides or the opposition's perspective when the source material has one, then a neutral closing CTA inviting readers to rate/review on Choseno. Plain text with simple line breaks and bullet dashes only — no Markdown headers (##), no emoji, no hashtags, no URL (Choseno appends the canonical link afterwards). Strictly neutral throughout, same rules as 'tweet'/'tweetmedium' — no loaded language, no editorializing. Leave blank to fall back to an auto-generated version.",
  "breakingNews": false,
  "author": {
...
- Tweet Article: Optional long-form neutral post for X Premium/X Articles (~800-1,500 chars) — headline line, 3-5 fact bullets pulled from the body, a balanced nod to the opposing view if one exists in the source, neutral rate/review CTA. No Markdown headers, emoji, hashtags, or URL.
  ...
  "batch": [
    {
      ...
      "tweetarticle": "OPTIONAL but recommended. Long-form neutral post for X Premium/X Articles (~800-1,500 chars): a short headline-style opening line, 3-5 fact bullets pulled straight from 'body', a balanced nod to any opposing perspective in the source material, then a neutral rate/review CTA. Plain text with simple line breaks/dashes only — no Markdown headers, emoji, hashtags, or URL.",
      "breakingNews": false,
...
16. **Tweet Article Copy (Optional):** Where the story has enough substance, also write \`tweetarticle\` — a longer neutral post for X Premium/X Articles (~800-1,500 chars per story) with a headline line, 3-5 fact bullets from the body, a balanced nod to any opposing perspective, and a neutral rate/review CTA. Plain text/line breaks only — no Markdown headers, emoji, hashtags, or URL.
