...
// frame that tilts flat and scales up as it scrolls into view. Reads
// `window.innerWidth` for its mobile breakpoint check, so this must stay a
// Client Component (no SSR) -- only used by the Home page's marketing hero.
