...
import { searchMapShapesByName, findBoundariesByPoint, syncUserBoundaryMemberships, addUserBoundaryMembership } from "@/lib/services/boundaries";
    ...
    <div className="w-full flex items-center justify-center py-6 sm:py-10 px-4">
      ...
      >
        ...
        <div className="p-5 sm:p-8">
          {currentStep === 1 && renderStepRole()}
          {currentStep === 2 && <StepLocation />}
          {currentStep === 3 && <StepUsername />}
          {currentStep === 4 && <StepPolitician />}
        </div>
      </Card>
    </div>
  );
